        ...
        >
            ...
            <div className="relative z-20 max-w-3xl w-full mx-4 px-6 py-16 md:p-16 bg-white/10 dark:bg-black/60 backdrop-blur-md rounded-lg border border-white/10 shadow-2xl text-center animate-fade-in-up">
                <div className="mb-8 flex justify-center">
                    <div className="w-20 h-20 rounded-full bg-[#A6864B]/20 flex items-center justify-center border border-[#A6864B]/50">
                        <span className="material-symbols-outlined text-5xl text-[#A6864B]">check_circle</span>
                    </div>
                </div>
                ...
                <div className="h-px w-24 bg-[#A6864B] mx-auto mb-8"></div>
                
                <div className="space-y-6 text-gray-200 text-lg md:text-xl font-light leading-relaxed max-w-2xl mx-auto">
                    <p>
                        Hemos recibido tu información exitosamente. En <span className="text-[#A6864B] font-semibold">Brickell Realty Group</span>, valoramos la excelencia y el talento único.
                    </p>
                    <p>
                ...
                <div className="mt-12 flex flex-col items-center space-y-4">
                    ...
                    <div className="flex gap-4">
                        {/* Facebook */}
                         <a href="https://www.facebook.com/p/Brickell-Realty-Group-100063637617298/?locale=es_LA" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center text-white hover:bg-[#A6864B] hover:border-[#A6864B] transition-all duration-300 group">
                        ...
                        {/* Instagram */}
                        <a href="https://www.instagram.com/brickell.realty.group/" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center text-white hover:bg-[#A6864B] hover:border-[#A6864B] transition-all duration-300 group" target="_blank" rel="noopener noreferrer">
                        ...
                        {/* LinkedIn */}
                        <a href="https://www.linkedin.com/company/brickell-realty-group/" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center text-white hover:bg-[#A6864B] hover:border-[#A6864B] transition-all duration-300 group" target="_blank" rel="noopener noreferrer">
